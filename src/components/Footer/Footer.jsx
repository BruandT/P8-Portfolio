    ...
    <>
      <footer id='contact' className='flex h-auto max-md:flex-col'>
        ...
        <div className='w-5/6 flex flex-col justify-end items-center bg-skin-bg-base max-md:w-full'>
          <a
            className='text-2xl text-skin-base max-sm:text-base max-sm:mt-4'
            href='mailto:thomas.bruand@gmail.com'
          >
            thomas.bruand@gmail.com
          </a>
          <p className='text-skin-base mt-8 max-sm:text-sm max-sm:mt-2'>
            © 2023 Thomas Bruand.
          </p>
        </div>
      </footer>
